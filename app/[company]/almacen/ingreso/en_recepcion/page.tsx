...
const InventarioPage = () => {
  ...
  const {
    ...
    isError,
  } = useGetInReceptionArticles(selectedStation ?? null, selectedCompany?.slug);
      ...
      <div className="flex flex-col gap-y-2">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Materialesen Recepcion</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        <h1 className="text-5xl font-bold text-center">MaterialesEn Recepción</h1>
        <p className="text-sm text-muted-foreground text-center italic mb-0">
          Aquí puede observar todos los Materialesque se encuentran fuera de almacén. <br />
