...
export const Calendar = ({ events, theme = 'light' }: CalendarProps) => {
  ...
  const calendar = useNextCalendarApp({
    ...
    defaultView: 'month',
    isResponsive: true,
    plugins: [dragAndDrop, eventsService, eventModal, resizePlugin],
            ...
            {calendarEvent && calendarEvent.work_order ? (
              <div className="flex justify-center">
                <Button variant="outline">
                  <Link
                    href={`/${selectedCompany?.slug}/planificacion/ordenes_trabajo/${calendarEvent.work_order.order_number}`}
  ...
  return (
    <div className="flex justify-center">
      ...
      <CreatePlanificationEventDialog open={isDialogOpen} onOpenChange={setIsDialogOpen} selectedDate={selectedDate} />
    </div>
  );
};
