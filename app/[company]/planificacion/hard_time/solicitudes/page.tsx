...
export default function InstallRequestsPage() {
  ...
  return (
    <ContentLayout title="Solicitudes de instalación">
      <main className="max-w-5xl p-4 lg:p-6">
