...
export function HardTimeCard({
  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-3 px-4 pb-3 pt-0">
        {closestMetric ? (
          <div className="flex items-center gap-2 rounded-md border border-border/60 bg-background/70 px-3 py-2">
            ...
            {(() => {
              ...
              return <Icon className="ml-auto h-3 w-3 shrink-0 text-muted-foreground/60" />;
            })()}
          </div>
          ...
          <div className="flex items-center gap-2 rounded-md border border-border/60 bg-background/70 px-3 py-2">
            ...
            <div className="text-[11px] text-muted-foreground">
              <span className="font-medium text-foreground">Sin promedio</span>
              <span className="ml-1.5">no se puede estimar vencimiento</span>
            </div>
          </div>
        ) : (
          canCreateInterval ? (
        ...
        <div className="flex items-center justify-between gap-2 pt-0.5">
          ...
          <div className="flex shrink-0 items-center gap-1" onClick={(e) => e.stopPropagation()}>
            ...
            <Button
              size="sm"
              variant="outline"
              className="h-6 gap-1 border-amber-500/30 px-2 text-[11px] text-amber-600 hover:bg-amber-500/10"
              onClick={(e) => {
                e.stopPropagation();
                onUninstall?.();
              }}
