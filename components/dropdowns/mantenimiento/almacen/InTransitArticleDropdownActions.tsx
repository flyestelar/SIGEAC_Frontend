...
const InTransitArticleDropdownActions = ({ id }: { id: number }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle className="text-center">¿Material en recepción?</DialogTitle>
          <DialogDescription className="text-center p-2 mb-0 pb-0">
            Indique si el Material ya se encuentra en recepción.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter className="flex flex-col gap-2 md:gap-0">
          ...
          <Button
            ...
            onClick={() => handleStatusUpdate(id, 'Reception')}
          >
