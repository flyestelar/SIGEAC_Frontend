          ...
          <DialogHeader className="gap-3 px-6 py-5">
            <div className="space-y-1">
              <DialogTitle className="text-xl font-semibold tracking-tight flex items-center gap-3">
                ...
                <span className="text-xs rounded-full border border-sky-500/30 bg-sky-500/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-sky-700">
                  AD {adNumber}
                </span>
              </DialogTitle>
              <DialogDescription>
                A continuación se muestra el documento PDF asociado a esta directiva de aeronavegabilidad.
              </DialogDescription>
            </div>
          </DialogHeader>
        </div>
