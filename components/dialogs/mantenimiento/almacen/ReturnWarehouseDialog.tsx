  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>
            Retorno de Articulo: <span className="italic font-medium">{serial}</span>
          </DialogTitle>
          <DialogDescription>Regrese el Material devuelta al almacén.</DialogDescription>
        </DialogHeader>
        <h1 className="text-center text-2xl font-bold">¿Seguro que desea retornar el Material al almacén?</h1>
