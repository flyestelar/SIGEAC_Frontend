          ...
          menus: [
            {
              ...
              active: pathname.includes(
                "/estelar/almacen/inventario/ingreso"
              ),
              icon: PackagePlus,
              roles: [
                "ANALISTA_ALMACEN",
              ...
              submenus: [
                {
                  ...
                  active:
                    pathname ===
                    "/estelar/almacen/ingreso/registrar_ingreso",
                },
                // {
              ...
              submenus: [
                {
                  ...
                  label: "Pendiente",
                  active:
                    pathname === "/estelar/almacen/solicitudes/pendiente",
                },
                {
            ...
            },
            {
              ...
              submenus: [
                ...
                },
                {
                  ...
                  label: "Entregado",
                  active:
                    pathname === "/estelar/almacen/inventario/entregado",
                },
              ],
            },
            {
              ...
              roles: ["ANALISTA_ALMACEN", "JEFE_ALMACEN", "SUPERUSER"],
              active: pathname.includes(
                "/estelar/almacen/caja_herramientas"
              ),
              icon: Wrench,
              submenus: [],
            },
          ...
          menus: [
            {
              ...
              active: pathname.includes(
                "/estelar/planificacion/ordenes_trabajo"
              ),
              icon: SquarePen,
              roles: [
                "ANALISTA_ADMINISTRACION",
              ...
              submenus: [
                {
                  ...
                  active:
                    pathname === "/estelar/planificacion/ordenes_trabajo",
                },
              ],
            },
            {
              ...
              submenus: [
                ...
                },
                {
                  ...
                  active:
                    pathname === "/estelar/planificacion/aeronaves/partes",
                },
              ],
            },
            {
              ...
              active: pathname.includes(
                "/estelar/planificacion/control_vuelos"
              ),
              icon: BookCheck,
              roles: [
                "ANALISTA_PLANIFICACION",
              ...
              submenus: [
                {
                  ...
                  active:
                    pathname ===
                    "/estelar/planificacion/control_vuelos/vuelos",
                },
                {
                  ...
                  active:
                    pathname ===
                    "/estelar/planificacion/control_vuelos/reportes",
                },
              ],
            },
          ],
        ...
        },
        {
          ...
          menus: [
            ...
            },
            {
              ...
              label: "Requisiciones",
              active: pathname.includes(
                "/estelar/general/requisiciones/nueva_requisicion"
              ),
              icon: ScrollText,
              roles: ["SUPERUSER"],
              submenus: [],
