...
export const emergencyPlans: EmergencyPlan[] = [
  {
    cardData: {
      imageUrl: `sms/images/promotions/fire-extinguisher.png`,
  ...
  {
    cardData: {
      imageUrl: `sms/images/promotions/airplane_fire.png`,
  ...
  {
    cardData: {
      imageUrl: `sms/images/promotions/fire_controled.png`,
  ...
  {
    cardData: {
      imageUrl: `sms/images/promotions/burning-building.png`,
  ...
  {
    cardData: {
      imageUrl: `sms/images/promotions/fire_tools.png`,
      imageAlt:
  ...
  {
    cardData: {
      imageUrl: `sms/images/promotions/collapse_by_fire.png`,
      imageAlt:
...
export const SMSresponsibilities = [
  {
    image: `${process.env.NEXT_PUBLIC_STORAGE_BASE_URL}sms/images/promotions/sms_estelar.png`,
